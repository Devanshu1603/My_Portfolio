...
const ProjectStats = ({ project }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-4 p-4 bg-[#0a0a1a] rounded-xl relative">
      ...
      <div className="relative z-10 flex items-center space-x-3 bg-white/5 p-3 rounded-lg border border-blue-500/20 hover:scale-105 transition">
        ...
        <div>
          ...
          <div className="text-xs text-gray-400">Total Technologies</div>
        </div>
      </div>
      <div className="relative z-10 flex items-center space-x-3 bg-white/5 p-3 rounded-lg border border-purple-500/20 hover:scale-105 transition">
        <div className="bg-purple-500/20 p-2 rounded-full">
          <Layers className="text-purple-300 w-6 h-6" strokeWidth={1.5} />
        </div>
        <div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="prose prose-invert max-w-none">
                <p className="text-base md:text-sm text-gray-300/90 leading-relaxed">
                  {project.detail}
                </p>
              </div>
                ...
                <a
                  ...
                  onClick={(e) => {
                    if (!handleGithubClick(project.github)) {
                      e.preventDefault(); // Prevent the anchor from triggering
                    }
                  }}
